...
def parser_enel(texto: str) -> Dict:
    ...
    # === Distribuidora
    if "ENEL DISTRIBUIÇÃO SÃO PAULO" in texto:
        distribuidora = "Enel SP"
    elif "ENEL DISTRIBUIÇÃO RIO" in texto:
        distribuidora = "Enel RJ"
    elif "ENEL DISTRIBUIÇÃO CEARÁ" in texto:
        distribuidora = "Enel CE"
    elif "ENEL DISTRIBUIÇÃO GOIÁS" in texto:
        distribuidora = "Enel GO"
    else:
        distribuidora = "Enel (Desconhecida)"
    ...
    # === Tipo de energia (heurística por tensão)
